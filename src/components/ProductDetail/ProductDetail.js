                ...
                <div className="row align-items-center justify-content-center">
                    <div className="col-lg-7 col-md-offset">
                        <img
                            src={product?.img}
                            draggable="false"
                            className="not-draggable w-75 d-block mx-auto"
                            alt=""
                        />
                    </div>

                    <div className="col-lg-5">
                        <h2 className="my-3 text-danger text-center text-lg-left">
                            {product?.name}
                        </h2>
                        <h3 className="text-success text-center text-lg-left">
                            <span className="h1 font-weight-bold text-success">৳</span>
                            {product?.price}
                        </h3>
                        ...
                        <div className="my-4">
                            ...
                            <h6 className="w-75 mx-auto mx-lg-0 d-flex flex-row justify-content-between align-items-center">
                                <span className="font-weight-bold">Material:</span> Fiber Stick
                            </h6>

                            <h6 className="w-75 mx-auto mx-lg-0 d-flex flex-row justify-content-between align-items-center">
                                <span className="font-weight-bold">Color:</span> Black
                            </h6>
                        ...
                        {showAdd & (loggedInUser?.role !== 'admin') ? (
                            <button
                                type="button"
                                onClick={addProduct}
                                className="btn btn-success d-block w-50 mx-auto mx-lg-0"
                            >
                                Add To Cart
                            </button>
                        ) : loggedInUser?.role !== 'admin' ? (
                            <>
                                <h5 className="text-danger font-weight-bold text-center text-lg-left">
                                    Added to Cart
                                </h5>
                                <button
                                    type="button"
                                    onClick={() => history.push('/cart')}
                                    className="btn btn-primary d-block w-50 mx-auto mx-lg-0"
                                >
                                    Go To Cart
                                </button>
                            </>
                        ) : (
                            <h4 className="text-danger text-center text-lg-left">
