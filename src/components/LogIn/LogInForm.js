...
const LogInForm = () => {
    ...
    const handleResponse = async (response) => {
        const fetchData = await fetch(
            `https://tonuscreation.herokuapp.com/getAdmin?email=${response.email}`
        );
    ...
    const fbSignIn = () => {
        handleFbSignIn().then((res) => handleResponse(res));
    };
            ...
            <div className="login-form">
                ...
                {!(location.hash === '#/reset') && (
                    <>
                        ...
                        <div
                            onClick={fbSignIn}
                            className="social-login d-flex justify-content-around align-items-center"
                        >
