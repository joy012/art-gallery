            ...
            <div className="login-form">
                {
                    user.error && <div className="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <h4>Close this error message and Create a New Account or Reset your Password! or Try Again please</h4>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="mt-3 mb-1">
                        {newUser ? 'Already have an account?' :
                            !(location.hash === '#/reset') ? "Don't have an account?" : ''}
                        <span className="orange-text" onClick={() => setNewUser(!newUser)}>
                            {newUser ? 'LogIn' :
                                !(location.hash === '#/reset') ? 'Create an account' : ''}
                        </span>
                    </p>
                </form>
                {
