...
const Checkout = () => {
    ...
    const subtotal =
        cart?.length !== 0
            ? cart.reduce((total, current) => total + parseInt(current?.price), 0)
            : parseInt(0);
                            ...
                            {cart.map((pd) => (
                                <li className="list-group-item d-flex justify-content-between lh-condensed">
                                    <div className="row w-75">
                                        ...
                                        <br />
                                        <small className="font-weight-bold col-6">
                                            Paper Type:{' '}
                                        </small>
                                    ...
                                    <h5 className="d-flex justify-content-between align-items-center">
                                        <span className="h3 font-weight-bold">৳ </span> {pd?.price}
                                    </h5>
                                </li>
                            ))}
                            <li className="list-group-item">
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <h6 className="d-flex justify-content-between align-items-center">
                                        <span className="h4 font-weight-bold">৳ </span> {subtotal}
                                    </h6>
                                </div>
                                {location.pathname === '/payment' && (
                                    <>
                            ...
                            <>
                                ...
                                <form className="needs-validation" noValidate autoComplete="off">
                                    ...
                                    orderDetail.mobile ? (
                                        ...
                                        <button
                                            type="button"
                                            className="btn btn-secondary btn-lg d-block mx-auto disabled"
                                        >
                                            Continue to Payment
                                        </button>
                                    )}
                            ...
                            <>
                                {orderDetail?.city === 'Sylhet' ? (
                                    ...
                                    <h4 className="mb-4 text-center">
                                        We only accept BKASH payment outside of Sylhet City
                                    </h4>
                                )}
                                <div className="row align-items-center justify-content-between mb-4">
                                        ...
                                        <div className="card h-100 col-6">
                                            ...
                                            >
                                                ...
                                                <button
                                                    type="button"
                                                    onClick={setCash}
                                                    className="w-75 d-block mx-auto btn btn-danger"
                                                >
                                                    Pay
                                                </button>
                                            </div>
                                    ...
                                    <div
                                        className={`card h-100 col-6 ${
                                            orderDetail?.city === 'Sylhet' ? '' : 'd-block mx-auto'
                                        }`}
                                    >
                                        <div
                                            className={`${
                                        ...
                                        orderDetail?.paymentMethod === 'Cash On' ? (
                                            <>
                                                ...
                                                <h5 className="text-center">
                                                    You can pay the Delivery Man at your doorstep!
                                                </h5>
                                                {!reCaptcha ? (
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="btn btn-success d-block w-50 my-4 mx-auto"
                                                    >
                                                        <div
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={placeOrder}
                                                        className="btn btn-success d-block w-50 mx-auto my-4"
                                                    >
                                                        Place Order
                                                    </button>
                                                )}
                                            ...
                                            <>
                                                ...
                                                <div className="mt-4">
                                                    <h5>
                                                        ...
                                                        via SMS. Enter your Transaction ID.
                                                    </h5>
                                                ...
                                                {orderDetail?.txId ? (
                                                    ...
                                                    <h6 className="text-danger mt-3">
                                                        Wrong Transaction ID may result in
                                                        unsuccessful order!!
                                                    </h6>
                                                )}
                                                {orderDetail?.txId && reCaptcha ? (
                                                    dbInitiate ? (
                                                        <button
                                                            type="button"
                                                            className="btn btn-success d-block w-50 my-4"
                                                        >
                                                            <div
                                                                className="spinner-border text-white"
                                                                role="status"
                                                    ...
                                                    <button
                                                        type="button"
                                                        className="btn btn-secondary d-block w-50 my-4 disabled"
                                                    >
                                                        Place Order
                                                    </button>
                                                )}
