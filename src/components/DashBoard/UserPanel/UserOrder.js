                        ...
                        <div className="col mb-4" key={order?._id}>
                            <div className="card h-100">
                                ...
                                {order?.status === 'PENDING' ? (
                                    <button
                                        type="button"
                                        className="w-75 btn btn-secondary d-block mx-auto text-center  text-white font-weight-bold my-4"
                                    >
                                        Status: {order?.status}
                                    </button>
                                    ...
                                    <button
                                        type="button"
                                        className="w-75 btn btn-primary d-block mx-auto text-center  text-white font-weight-bold my-4"
                                    >
                                        Status: {order?.status}
                                    </button>
                                    ...
                                    <button
                                        type="button"
                                        className="w-75 going btn d-block mx-auto text-center  text-white font-weight-bold my-4"
                                    >
                                        Status: {order?.status}
                                    </button>
                                    ...
                                    <button
                                        type="button"
                                        className="w-75 btn shipped d-block mx-auto text-center  text-white font-weight-bold my-4"
                                    >
                                        Status: {order?.status}
                                    </button>
                                ) : order?.status === 'DONE' ? (
                                    <button
                                        type="button"
                                        className="w-75 btn btn-success d-block mx-auto text-center  text-white font-weight-bold my-4"
                                    >
                                        Status: {order?.status}
                                    </button>
                                ) : (
                                    <button
                                        type="button"
                                        className="w-75 btn btn-danger d-block mx-auto text-center  text-white font-weight-bold my-4"
                                    >
                                        Status: {order?.status}
                                    </button>
                                )}
                                <div className="card-body">
                                    <h5 className="card-title text-center text-danger h4">
                                        {singleOrder?.name}
                                    </h5>
                                ...
                                <div className="card-footer">
                                    <p className="text-success h5 font-weight-bold text-center">
                                        Price:{' '}
                                        <span className="h3 font-weight-bold text-success">৳</span>
                                        {singleOrder?.price}
                                    </p>
                                </div>
                            </div>
